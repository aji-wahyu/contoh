				...
				<div class="container-fluid">
					<div class="page-content-wrapper">
						<div class="mt-3">
							...
							<h3 class=""><strong>Edit Tempat Wisata</strong></h3>
						</div>
						<div class="row">
							<div class="col-lg-6">
								<div class="card">
									<div class="card-body">
										<div class="p-0">
											<p>Berikut adalah form mengubah data Tempat Wisata. silahkan lengkapi data-data dibawah ini dengan lengkap dan benar</p>
											<hr />
											<form action="<?= site_url('admin/Wisata/edit/' . $rsRow->id) ?>" method="POST" enctype="multipart/form-data">
												...
												<div class="form-group">
													...
													<textarea class="form-control" name="desc" rows="6" placeholder=""><?= $rsRow->desc ?></textarea>
												</div>
												...
												<div class="form-group mt-2">
													...
													<img class="img-fluid" src="<?= base_url('uploads/' . $rsRow->picture) ?>" style="width:200px;">
													<?= $this->session->userdata('errorUpload') ?>
												</div>

												<div class="form-group mt-3">
													<a href="<?= site_url('admin/Wisata') ?>" class="btn btn-light">Kembali</a>
					...
					markers.push(new mapboxgl.Marker({
						...
						<img src="<?= base_url('uploads/') ?>${i.picture}" class="card-img-top" alt="...">
							<div class="card-body">
								...
								${i.type == 'object' ? `<a href="<?= site_url('Wisata/detail/') ?>${i.id}" class="btn btn-primary">Lihat detail</a>` : ''}
								</div>
							</div>
						`)) // add popup
						.addTo(map));
