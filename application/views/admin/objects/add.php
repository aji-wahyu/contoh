				...
				<div class="container-fluid">
					<div class="page-content-wrapper">
						<div class="mt-3">
							...
							<h3 class=""><strong>Tambah Tempat Wisata </strong></h3>
						</div>
						<div class="row">
							<div class="col-lg-6">
								<div class="card">
									<div class="card-body">
										<div class="p-0">
											<p>Berikut adalah form data tempat wisata. silahkan lengkapi data-data dibawah ini dengan lengkap dan benar</p>
											<hr />
					...
					markers.push(new mapboxgl.Marker({
						...
						<img src="<?= base_url('uploads/') ?>${i.picture}" class="card-img-top" alt="...">
							<div class="card-body">
								...
								${i.type == 'object' ? `<a href="<?= site_url('Wisata/detail/galeri/') ?>${i.id}" class="btn btn-primary">Lihat detail</a>` : ''}
								</div>
							</div>
						`)) // add popup
						.addTo(map));
