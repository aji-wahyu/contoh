...
<body>
			...
			<div class="page-content">
				<div class="container-fluid">
					<div class="page-content-wrapper">
						<div class="mt-3">
							<h3 class=""><strong>Tempat Wisata Temanggung</strong></h3>
						</div>
						<div class="row">
							<div class="col-lg-6">
								<div class="card">
									<div class="card-body">
										<a href="<?= site_url('admin/Wisata/add') ?>" class="btn btn-primary mb-3">Tambah Titik Tempat Wisata</a>
										<div class="p-0 table-responsive">
											<p>Berikut adalah data tempat wisata yang terdaftar.</p>
	...
	<script type="text/javascript">
		...
		var dtb_ = $("#datatable").DataTable({
			...
			"responsive": true,
			"ajax": {
				"url": "<?= site_url('admin/Wisata/ajax/list') ?>",
				"type": "POST",
			}
		});
		...
		function deleteData(id) {
			...
			if (conf) {
				window.location = "<?= site_url('admin/Wisata/delete/') ?>" + id;
			}
		}
	</script>
</body>
