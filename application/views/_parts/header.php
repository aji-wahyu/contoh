	...
	<div class="navbar-header">
		<div class="d-flex">
			...
			<div class="navbar-brand-box">
				<a href="<?= site_url('Wisata') ?>" class="logo logo-dark">
					<span class="logo-lg">
						<img src="<?= base_url() ?>assets/djk.png" alt="" height="65">  
					</span>
			...
			<?php if ($this->session->has_userdata('admin')) { ?>
				<div class="dropdown d-inline-block">
					<button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						...
						<span class="d-none d-xl-inline-block ms-1"><?= $this->session->userdata('admin')->username ?></span>
