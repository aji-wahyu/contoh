...
<head>
	...
	<!-- App favicon -->
	<link rel="shortcut icon" href="assets/djk.png">
...
<body style="background-image: url('assets/vnewlogin.jpg');height: 100%;background-position: center;background-repeat: no-repeat;background-size: cover;">
							...
							<div class="card-body">
								<div class="px-2 py-3">
									...
									<div class="text-center">
										<a href="<?= site_url() ?>">
											<img src="assets/djk.png" height="150" alt="logo"><!--Ganti Logo-->
										</a>

										<h5 class="text-primary mb-2 mt-4">Welcome To Wisata Temanggung</h5>
									</div>
