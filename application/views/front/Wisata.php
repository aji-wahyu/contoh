			...
			<div class="page-content">
				<div class="container-fluid">
					<div class="page-content-wrapper">
						<div class="mt-3">
							<h3 class=""><strong>Info Tempat Wisata<strong></h3>
						</div>
								...
								<div class="col-6 col-sm-3 d-flex align-items-stretch">
									<div class="card">
										...
										<div class="card-body">
											...
											<p class="card-text text-sm"><?= substr($gng->desc, 0, 50) . '...' ?><br /><a href="<?= site_url('Wisata/detail/' . $gng->id) ?>"><strong>Selengkapnya</strong></a></p>
										</div>
									</div>
								</div>
							<?php } ?>
