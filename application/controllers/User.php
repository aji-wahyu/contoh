...
class User extends CI_Controller
{
	...
	/**
	 * index
	 * menampilkan halaman daftar Tempat Wisata Temanggung
	 * @return void
	 */
	...
	/**
	 * add
	 * untuk menampilkan form dan menyimpan data Tempata Wisata
	 * @return void
	 */
	public function add()
	{
	...
	/**
	 * edit
	 * untuk menampilkan form dan memperbarui data Tempat Wisata
	 * @return void
	 */
	...
	public function delete($id)
	{
		...
		$this->session->set_flashdata('statusMessage', alert('success', 'Data Tempata Wisata berhasil dihapus'));
		redirect('admin/user');
	}
	...
	public function ajaxlist()
	{
		...
		$datatables->query('SELECT id,username,password,inserted_at FROM admin');
		$datatables->hide('id');
